module MustUseRetVal.Tests.Support.DiagnosticMatcher
...
module Expect = 
    ...
    open MustUseRetVal.Tests.Support.DiagnosticFormatter
    open MustUseRetVal.Tests.Support.DiagnosticResult
